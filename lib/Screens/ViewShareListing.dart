...
class ViewShareListing extends StatefulWidget {
  ...
  ViewShareListing(this.listing);
  @override
  _ViewShareListingState createState() => _ViewShareListingState(this.listing);
}

class _ViewShareListingState extends State<ViewShareListing>
    with SingleTickerProviderStateMixin {
  ListingSharing listing;
  _ViewShareListingState(this.listing);
